        ...
        <div>
            ...
            <ul class="list"  v-if="!smallView">
                <li class="list_item" v-for="(pic,index) in pices">
                    <div class="list_main">
                        <div class="assign_homework" @click="clientSwiper(pices,index)">
                        ...
                        <div class="handle_area" flex="cross:center main:justify">
                            <div class="handle_left" flex-box="0" flex="cross:center">
                                <span flex-box="0" class="doFavorite" :class="{'didFavorite':pic.praiseState==1,}" @click="praiseFuc(index,pic.picId)"></span>
                                <span flex-box="0" class="share" @click="share(index,pic)"></span>
                                <span flex-box="0" class="talk" @click="setComment(index,pic.picId,pic.vedioId)"></span>
                            </div>
                        </div>
    ...
    export default{
        ...
        methods: {
            ...
            refresh () {
                ...
                API.getClaimData(param).then(res=>{
                    let {code,rs}=res;
                    if(code==200){
                        if(rs.className){
            ...
            share(index,object){
                //TODO:分享页面跳转
                let obj={};
                obj.tid=object.picId+'_'+this.classId;
