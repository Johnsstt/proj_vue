            ...
            <div class="tp-extra-row">
                <div class="tp-extra-self">
                    ...
                    <div class="tp-extra-con">
                        <textarea name="" class="textarea" v-model="selfAppraisal" placeholder="介绍一下自己的优势" ></textarea>
                    </div>
                </div>                
            </div>
	                ...
	                API.saveSelfAppraisal(param).then(function(res){
	                    ...
	                    if(data.success == true) {                        
	                        if(uid) {
		                        ...
		                        location.href = baseUrl + '/mobile/job.htm';
		                    }
	                    }else {
	                    	that.toast({text: '自我介绍为空或格式不正确'});
	                    }
	                });                   
